...
parser.add_argument('--dataset', type = str, default='BD_CC', help= 'the name of the dataset')
parser.add_argument('--input_captions_json',
                    type = str,
                    default = '/home/september/code/ICC/data/BD_CC/BDCCcaptions.json',
                    help = 'input captions json file')
parser.add_argument('--save_dir', type = str, default = './data/BD_CC/')
...
def main(args):
    if args.dataset == 'LEVIR_CC' or 'DUBAI_CC' or 'BD_CC':
    ...
    assert args.dataset in {'LEVIR_CC', 'DUBAI_CC', 'BD_CC'}
